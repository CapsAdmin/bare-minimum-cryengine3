				...
				case ESYSTEM_EVENT_LEVEL_LOAD_START:
					{
						...
						ICVar *pCVar = gEnv->pConsole->GetCVar("r_EyeAdaptationBase");
						assert(pCVar);
...
bool CGameStartup::InitWindow(SSystemInitParams &startupParams)
{
	...
	wc.hCursor       = LoadCursor(NULL, IDC_ARROW);//LoadCursor((HINSTANCE)startupParams.hInstance, MAKEINTRESOURCE(DEFAULT_CURSOR_RESOURCE_ID));
