...
public:
	...
	CryStringLocalT( const_str begin, const_str end )
		: BaseType(begin, end)
		{}
	CryStringLocalT( value_type ch, size_type nRepeat = 1 )
		: BaseType(ch, nRepeat)
	{}
...
template <>
inline int CryStringT<wchar_t>::compare( const CryStringT<wchar_t>& _Str ) const
{
...
template <>
inline int CryStringT<wchar_t>::compare( const wchar_t* _Ptr	) const
{
...
template <>
inline int CryStringT<wchar_t>::compareNoCase( const CryStringT<wchar_t>& _Str ) const
{
	return wcsicmp( m_str,_Str.m_str );
}
...
template <>
inline int CryStringT<wchar_t>::compareNoCase( const wchar_t* _Ptr	) const
{
	return wcsicmp( m_str,_Ptr );
}
