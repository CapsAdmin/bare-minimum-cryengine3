...
#define MTL_FLAGS_SAVE_MASK (MTL_FLAG_WIRE|MTL_FLAG_2SIDED|MTL_FLAG_ADDITIVE|MTL_FLAG_DETAIL_DECAL|MTL_FLAG_LIGHTING|\
				MTL_FLAG_NOSHADOW|MTL_FLAG_MULTI_SUBMTL|MTL_FLAG_SCATTER|MTL_FLAG_REQUIRE_FORWARD_RENDERING|MTL_FLAG_HIDEONBREAK|MTL_FLAG_UIMATERIAL|MTL_64BIT_SHADERGENMASK|MTL_FLAG_REQUIRE_NEAREST_CUBEMAP)

#define MTL_FLAGS_TEMPLATE_MASK (MTL_FLAG_WIRE|MTL_FLAG_2SIDED|MTL_FLAG_ADDITIVE|MTL_FLAG_DETAIL_DECAL|MTL_FLAG_LIGHTING|\
				MTL_FLAG_NOSHADOW|MTL_FLAG_SCATTER|MTL_FLAG_REQUIRE_FORWARD_RENDERING|MTL_FLAG_HIDEONBREAK|MTL_FLAG_UIMATERIAL|MTL_64BIT_SHADERGENMASK|MTL_FLAG_REQUIRE_NEAREST_CUBEMAP)

#define MTL_FLAGS_MERGABLE_MASK (MTL_FLAG_WIRE|MTL_FLAG_2SIDED|MTL_FLAG_ADDITIVE|MTL_FLAG_DETAIL_DECAL|MTL_FLAG_LIGHTING|\
        MTL_FLAG_NOSHADOW|MTL_FLAG_SCATTER|MTL_FLAG_REQUIRE_FORWARD_RENDERING|MTL_FLAG_HIDEONBREAK|MTL_64BIT_SHADERGENMASK||MTL_FLAG_REQUIRE_NEAREST_CUBEMAP)
...
UNIQUE_IFACE struct IMaterialManager
{
  ...
  virtual IMaterial* GetDefaultLayersMaterial() = 0;
	...
	// Description:
	//    Retrieve a default engine material that will not be drawn.
	virtual IMaterial* GetNoDrawMaterial() = 0;
