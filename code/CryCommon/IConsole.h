...
enum EVarFlags
{
	...
	VF_NOT_NET_SYNCED_INTERNAL	= VF_INTERNAL_FLAGS_START,			// can be changed on client and when connecting the var not sent to the client (is set for all vars in Game/scripts/Network/cvars.txt)
	VF_INTERNAL_FLAGS_END = VF_NOT_NET_SYNCED_INTERNAL
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	virtual ConsoleVarFunc GetOnChangeCallback() = 0;
