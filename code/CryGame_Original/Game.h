	...
	public IGame, public IGameFrameworkListener, public ISystemEventListener
{
	...
	public:
		...
		{
			return m_pScriptBindHitDeathReactions;
		}
		ILINE CHitDeathReactionsSystem &GetHitDeathReactionsSystem() const
		{
			CRY_ASSERT(m_pHitDeathReactionsSystem);
			return *m_pHitDeathReactionsSystem;
		}
		...
		CScriptBind_MatchMaking *GetMatchMakingScriptBind()
		{
			return m_pScriptBindMatchMaking;
		}
		...
		CGameFriendsManager *GetGameFriendsManager()
		{
			return m_gameFriendMgr;
		}
		CGameServerLists	*GetGameServerLists()
		{
			return m_pGameServerLists;
		}
#endif //IMPLEMENT_PC_BLADES

		CGameLobby *GetGameLobby();
		CGameLobbyManager *GetGameLobbyManager()
		{
			return m_pGameLobbyManager;
		}
		IPlayerProfileManager *GetPlayerProfileManager()
		{
			return m_pPlayerProfileManager;
		}
		CGameBrowser *GetGameBrowser()
		{
			return m_pGameBrowser;
		}
		CSquadManager *GetSquadManager()
		{
			return m_pSquadManager;
		}
		...
		EInviteAcceptedState GetInviteAcceptedState()
		{
			return m_inviteAcceptedState;
		}
		...
		{
			return m_inviteAcceptedData.m_user;
		}
		const bool IsInviteInProgress() const
		{
			return m_inviteAcceptedState != eIAS_None;
		}

		CSPAnalyst *GetSPAnalyst() const
		{
			return m_pSPAnalyst;
		}
