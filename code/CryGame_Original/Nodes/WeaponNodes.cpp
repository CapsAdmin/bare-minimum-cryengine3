...
namespace
{
	...
	IActor* GetActor(CFlowBaseNode<eNCT_Singleton>::SActivationInfo* pActInfo)
	{
...
*/
class CFlowNode_WeaponAccessoryChanged : public CFlowBaseNode<eNCT_Instanced>
{
public:
	...
	virtual ~CFlowNode_WeaponAccessoryChanged()
	{
	}
