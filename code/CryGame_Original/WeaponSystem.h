...
-------------------------------------------------------------------------
History:
- 18:10:2005   17:41 : Created by Marcio Martins
...
class CWeaponSystem : public ILevelSystemListener
{
	...
	public:
		...
		CTracerManager &GetTracerManager()
		{
			return m_tracerManager;
		};
		...
		bool IsFrozenEnvironment()
		{
			return m_frozenEnvironment;
		}
		bool IsWetEnvironment()
		{
			return m_wetEnvironment;
		}
