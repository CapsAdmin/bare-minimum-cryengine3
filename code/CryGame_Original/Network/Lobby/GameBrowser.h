...
public :
	...
	void SetHasEnteredLoginDetails(bool hasEntered) { m_hasEnteredLoginDetails = hasEntered; }
	bool HasEnteredLoginDetails() const { return m_hasEnteredLoginDetails; }

	void SetLoginGUIState(ECryLobbyLoginGUIState guiState) { m_loginGUIState = guiState; }
	ECryLobbyLoginGUIState GetLoginGUIState() { return m_loginGUIState; }
...
protected:
	...
	ENatType m_NatType;
	ECryLobbyLoginGUIState m_loginGUIState;
...
private:
	...
	static void* ObfuscateGameSpyTitle();
	static void* ObfuscateGameSpySecretKey();
#endif
