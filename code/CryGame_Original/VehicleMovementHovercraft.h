	...
	: public CVehicleMovementBase
{
	public:
		...
		{
			return eVMT_Amphibious;
		}

		virtual bool SetParams(const CVehicleParams &table);
		virtual bool SetSounds(const CVehicleParams &table)
		{
			return true;
		}
		...
		{
			return m_isEnginePowered || m_bEngineAlwaysOn;
		}
