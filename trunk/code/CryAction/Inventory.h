...
struct TRMIInventory_EquipmentPack
{
  ...
  TRMIInventory_EquipmentPack( const char* _pEquipmentPack )
...
public:
  ...
  virtual void RemoveAllItems();
	...
	virtual void RMIReqToServer_AddAmmo           ( const char* _pszAmmoClass, int _iAmount ) const;
	virtual void RMIReqToServer_RemoveAllAmmo     () const;
	virtual void RMIReqToServer_AddEquipmentPack  ( const char* _pszEquipmentPack ) const;
	...
	virtual IEntityClass* GetTossItem() const;
	virtual void SetTossItem(IEntityClass* tossItem);

	virtual void SetLastItem(EntityId itemId);
	virtual EntityId GetLastItem() const;
	virtual unsigned int GetLastSelectedInSlot(IInventory::EInventorySlots slotId) const;
	...
	DECLARE_SERVER_RMI_NOATTACH( SvReq_RemoveAllAmmo,     TRMIInventory_Dummy,          eNRT_ReliableOrdered );
...
private:
	...
	void RemoveItemFromCategorySlot(EntityId entityId);
