...
//==================================================================================================
// Name: SApplyGlassImpactParams
// Desc: Glass impact parameters
// Author: Chris Bunner
//==================================================================================================
struct SApplyGlassImpactParams
{
	SApplyGlassImpactParams()
	: velocity(Vec3Constants<f32>::fVec3_Zero)
	, impulse(0.0f)
	, x(0.0f)
	, y(0.0f)
	...
	const EventPhysCollision* pPhysEvent;
	bool		force;
};//------------------------------------------------------------------------------------------------
...
//==================================================================================================
typedef CryFixedArray<Vec2, 35> TGlassDefFragmentArray;	// Using a large size here, but most are just quads
...
struct SBreakableGlassCVars
{
	...
	, m_decalRandChance(0.75f)
	, m_decalRandScale(3.6f)
	, m_minImpactSpeed(400.0f)
	, m_fragImpulseScale(12.0f)
	, m_fragAngImpulseScale(0.15f)
	, m_fragImpulseDampen(0.75f)
