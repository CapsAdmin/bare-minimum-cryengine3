...
#define FOB_MASK_AFFECTS_MERGING_GEOM  (FOB_NEAREST | FOB_VEGETATION | FOB_CHARACTER | FOB_BENDED | FOB_NO_STATIC_DECALS | FOB_BLEND_WITH_TERRAIN_COLOR | FOB_ALLOW_TESSELLATION)
