...
{	
  ...
  virtual IIndexedMesh * CreateIndexedMesh() = 0;	// see implementation for details of the lifetime of the mesh returned
};
...
UNIQUE_IFACE struct ILPVRenderNode : public IRenderNode
{
