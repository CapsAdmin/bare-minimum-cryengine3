...
#define DECLARE_JOB_INVOKER_GENERATOR( type, function ) \
	...
	{	\
		/* for free function which don't take any parameters, we need some special handling */\
		/* thus we use on extra abstraction level to prevent trying to call wrong functions */\
		/* function overload to call the free function */\
		static void CallFunction( void (*pFunc)() ) { (*pFunc)(); } \
\
		/* function overloads to catch all invalid function signatures */\
		template<typename T0>\
		static void CallFunction( void (*pFunc)(T0) ) { /*nothing*/ } \
		template<typename T0,typename T1>\
		static void CallFunction( void (*pFunc)(T0,T1) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2>\
		static void CallFunction( void (*pFunc)(T0,T1,T2) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3,typename T4>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3,T4) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3,typename T4, typename T5>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3,T4,T5) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3,T4,T5,T6) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7,typename T8>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7,T8) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7,typename T8,typename T9>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9) ) { /*nothing*/ } \
		template<typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7,typename T8,typename T9,typename T10>\
		static void CallFunction( void (*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10) ) { /*nothing*/ } \
		template<typename C>\
		static void CallFunction( void (C::*pFunc)() ) { /*nothing*/ } \
		template<typename C,typename T0>\
		static void CallFunction( void (C::*pFunc)(T0) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1>\
		static void CallFunction( void (C::*pFunc)(T0,T1) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3,typename T4>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3,T4) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3,typename T4, typename T5>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3,T4,T5) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3,T4,T5,T6) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7,typename T8>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7,T8) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7,typename T8,typename T9>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9) ) { /*nothing*/ } \
		template<typename C,typename T0,typename T1,typename T2,typename T3,typename T4, typename T5, typename T6, typename T7,typename T8,typename T9,typename T10>\
		static void CallFunction( void (C::*pFunc)(T0,T1,T2,T3,T4,T5,T6,T7,T8,T9,T10) ) { /*nothing*/ } \
...
\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3, typename T4>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3, params->t4); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3, params->t4, params->t5); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3, params->t4, params->t5, params->t6); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3, params->t4, params->t5, params->t6, params->t7); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3, params->t4, params->t5, params->t6, params->t7, params->t8); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3, params->t4, params->t5, params->t6, params->t7, params->t8, params->t9); \
		} \
	}; \
\
	template<typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10>\
	...
	{	\
		...
		{\
			...
			function(params->t0, params->t1, params->t2, params->t3, params->t4, params->t5, params->t6, params->t7, params->t8, params->t9, params->t10); \
		} \
	}; \
\
...
\
		...
		static void RegisterSPUJobHandle();\
		uint32 GetJobID(); \
...
\
	inline const uint32 SGenericJob ## type::GetJobAddress()\
	{\
...
\
	...
	{\
		this->m_JobDelegator.SetDedicatedThreadOnly(); \
	}\
\
...
\
	inline void packet ## type::SetDedicatedThreadOnly()\
	{\
		m_bDedicatedThreadOnly = true;\
	}\
	\
	inline bool packet ## type::IsDedicatedThreadOnly() const\
	{\
		return m_bDedicatedThreadOnly;\
	}\
\
	template<typename C> \
...
// for SPU we use a similar marco, just
#define DECLARE_JOB_INVOKER_CLASS_SPU(name, type, function) \
namespace JobManager {\
namespace Detail { \
\
	/* packet structure for the Producer/Consumer Queue */ \
...
\
		/*******************************************/\
		/* Common non job dependent interface part */ \
		/*TODO check which of those need to be public at all */\
		static const JobManager::TJobHandle GetProgramHandle(); \
		static void RegisterSPUJobHandle();\
		uint32 GetJobID(); \
		const char* GetJobName() const; \
		const char* GetJobName() const volatile; \
...
\
	/*******************************************/\
	/* Implementation of SGenericJob functions */ \
	inline const JobManager::TJobHandle SGenericJob ## type::GetProgramHandle()\
	{\
		return gJobHandle ## type; \
	}\
\
