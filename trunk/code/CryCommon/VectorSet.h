...
//   vector::capacity()).
//
// * void resize(size_type new_size, const key_type& x=key_type());
//   see vector::resize()).
//
//--------------------------------------------------------------------------
...
public:
	...
	iterator begin();
	size_type capacity() const;
	void resize(size_type __new_size, const key_type& __x=key_type());
	void clear();
  ...
  const_reverse_iterator rend() const;
	...
	value_type& operator[](int index);              // See documentation above
...
template <typename K, typename T, typename A>
void VectorSet<K, T, A>::resize(size_type __new_size, const key_type& __x)
{
...
template <typename K, typename T, typename A>
size_t VectorSet<K, T, A>::erase(const key_type& key)
{
