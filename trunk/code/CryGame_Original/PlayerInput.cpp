...
{
	bool canMove = (!m_pPlayer->GetHitDeathReactions() || m_pPlayer->GetHitDeathReactions()->CanActorMove()) || !m_pPlayer->m_stats.spectatorMode || m_pPlayer->m_stats.spectatorMode == CActor::eASM_Fixed;
