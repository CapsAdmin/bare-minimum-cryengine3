	...
	public IGameObjectProfileManager
{
	...
	public:
		...
		virtual int  GetDefaultHand() const;
		...
		virtual void DropImmediate(float impulseScale = 1.0f, bool selectNext = true, bool byDeath = false)
		{
			Drop(impulseScale, selectNext, byDeath);
		}
	...
	public:
		...
		uint32 GetCurrentAnimationEnd(int slot);
		uint32 GetCurrentAnimationStart(int slot);
	...
	protected:
		...
		TInitialSetupMap			m_initialSetup;
		string								m_currentInitialSetup;
		...
		uint32									m_animationEnd[eIGS_Last];
	...
	protected:
		...
		bool									m_registeredAs1pUser;
		bool									m_registeredAs3pUser;
