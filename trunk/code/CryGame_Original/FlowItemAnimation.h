	...
	public:
		...
		struct FlowPlayItemAnimationAction
		{
			...
			void execute(CItem *pItem)
			{
				...
				{
					pItem->SetBusy(true);
					pItem->GetScheduler()->TimerAction(pItem->GetCurrentAnimationTime(eIGS_FirstPerson), CSchedulerAction<FlowPlayItemAnimationActionUnbusy>::Create(), false);
				}
			}
		};
	...
	public:
		...
		struct FlowPlayOffhandAnimationAction
		{
			...
			void execute(CItem *pOffHand)
			{
				...
				pOffHand->GetScheduler()->TimerAction(pOffHand->GetCurrentAnimationTime(eIGS_FirstPerson), CSchedulerAction<FlowPlayOffhandAnimationActionDone>::Create(), false);
			}
		};
