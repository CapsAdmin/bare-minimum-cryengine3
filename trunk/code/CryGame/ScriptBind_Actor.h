	...
	public CScriptableBase
{
	public:
		...
		// <title SetMovementControlledByAnimation>
		// Syntax: Actor.SetMovementControlledByAnimation(true);
		// Arguments:
		//		enable - enable or disable animation controlled movement
		// Description:
		//		Enables or disables animation controlled movement for an actor.
		virtual int SetMovementControlledByAnimation(IFunctionHandler *pH, bool enable);
